 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zrad_Tool_Project_Context_Zf_ApplicationConfigForm extends Zend_Tool_Project_Context_Filesystem_File
{

    /**
     * @var string
     */
    protected $_filesystemName = 'admin-form.ini';
    ...
    protected function _getDefaultContents()
    {
        ...
        $contents =<<<EOS
[images]
;thumb.table.field.resize.type = "exact"
[files]
;file.table.field.validator.extension = "xls,xlsx"
[editor]
;editor.test
