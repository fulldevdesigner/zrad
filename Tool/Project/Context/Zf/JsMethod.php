 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zrad_Tool_Project_Context_Zf_jsMethod implements Zend_Tool_Project_Context_Interface
{
    ...
    {
        if (self::createJsMethod($this->_controllerPath, $this->_actionName) === false) {
            require_once 'Zend/Tool/Project/Context/Exception.php';
     ...
     * @return true
     */
    public static function createJsMethod($controllerPath, $actionName, $body = '        // action body')
    {
